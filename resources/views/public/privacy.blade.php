...
<head>
    ...
    <title>Política de Privacidade - JobBot AI</title>
...
<body class="bg-slate-50 font-sans text-slate-800 antialiased">
    ...
    <main class="max-w-4xl mx-auto px-6 py-20">
        <div class="bg-white p-12 md:p-20 rounded-[3rem] shadow-sm border border-slate-200">
            <h1 class="text-4xl md:text-5xl font-black tracking-tighter mb-10">Política de <span class="text-blue-600">Privacidade</span></h1>
